...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $query = "SELECT last_transaction_number FROM transaction_counter FOR UPDATE"; // Lock the row to prevent race conditions
        ...
        if ($result && $result->num_rows > 0) {
            ...
            $lastTransactionNumber = 0; // Default value if the table is empty
        }
