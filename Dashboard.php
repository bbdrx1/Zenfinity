...
<?php
// Assuming your "transaction" table has a column named "price"
$sql = "SELECT SUM(price) as total_earnings FROM transaction";
...
// Assuming your "transaction" table has a column named "price" and "EntryTimestamp"
$sql = "SELECT SUM(price) as total_earnings FROM transaction WHERE MONTH(EntryTimestamp) = $currentMonth AND YEAR(EntryTimestamp) = $currentYear";
$result = $conn->query($sql);
